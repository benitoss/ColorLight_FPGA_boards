...
Mac ans Linux version require of OpenFPGALoader version of each SO. You can get the OpenFPGALoader compiled binary version from [here](https://github.com/YosysHQ/fpga-toolchain/releases/tag/nightly-20210418)
